 ...
 *
 * @param <TUser>    the type representing the user or recipient
 * @param <TMessage> the type representing the message or data to send
 */
public interface INotificationSender<TUser, TMessage> {
     ...
     * @param message content or data of the message
     */

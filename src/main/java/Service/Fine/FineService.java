...
public class FineService
{
     ...
     *            validator for fine payment amounts
     */
    public FineService(UserRepository userRepository, FineHistoryRepository fineHistoryRepository,
     ...
     *
     * @param user
     *            the user paying the fine
     * @param rawAmount
     *            amount entered as string

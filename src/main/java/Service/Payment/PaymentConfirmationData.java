 ...
 *
 * @param patronName        name of the user who made the payment
 ...
 * @param processedBy       name of the staff or system that processed the payment
 * @param previousBalance   user's balance before payment
 * @param remainingBalance  user's balance after payment

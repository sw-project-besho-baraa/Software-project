 ...
 * <p>
 * This utility is used to determine which UI screen should be loaded
 * after a successful login based on the user's role.
 */
@Component
public class RoleToFxmlMapper {
     ...
     *
     * @param role the {@link UserRole} of the user

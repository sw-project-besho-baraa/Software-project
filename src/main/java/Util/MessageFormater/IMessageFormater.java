...
/**
 * Defines a generic contract for converting message data objects into formatted
 * output.
 * <p>
 * Typically used to generate HTML email content or structured text from typed
 * message data objects.
 *
 * @param <IMessageObj>
 *            the type of input message data object
 */

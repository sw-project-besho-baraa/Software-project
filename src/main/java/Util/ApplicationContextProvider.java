 ...
 * <p>
 * This utility allows non-managed classes (those not created by Spring) to
 * retrieve Spring-managed beans at runtime.
 */
@Component
public class ApplicationContextProvider
{
     ...
     *            the Spring context injected by the framework
     */

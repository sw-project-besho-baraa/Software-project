...
public class FineResolver {
     ...
     *
     * @param item the media item for which to determine the fine
     * @return the fine amount as a {@link BigDecimal}
     * @throws NotImplementedException if the item's media type is unsupported
     */
    public static BigDecimal getFine(MediaItem item) {
        ...
        return switch (item.getMediaType()) {
            ...
            default -> throw new NotImplementedException(
                    "Fine not implemented for media type: " + item.getMediaType()
            );
        };
    }
}

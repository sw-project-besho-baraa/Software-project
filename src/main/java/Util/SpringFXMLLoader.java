...
/**
 * Utility class that integrates Spring's {@link ApplicationContext} with
 * JavaFX's {@link FXMLLoader}.
 * <p>
...
public final class SpringFXMLLoader
{
     ...
     *
     * @param fxmlPath
     *            the classpath-relative path to the FXML file (e.g.
     *            "/fxml/login.fxml")
     * @return a configured {@link FXMLLoader} instance ready to load
     * @throws IllegalArgumentException
     *             if the FXML resource cannot be found
     */
